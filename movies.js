    ...
    switch (req.url) {
        ...
        case '/':
            ...
            res.write(`
                        ...
                        - Contacto (/contacto)
                        - Preguntas frecuentes (/preguntas-frectuentes)
                        `)
            res.end();
            break;
        ...
        case '/en-cartelera':
            ...
            movies.forEach(movies => {
                res.write('' + movies.title)
                res.write('\n\n')
                res.write('Descripcion :' + movies.overview)
                res.write('\n\n');
            })
        ...
        case '/mas-votadas':
            ...
            res.write('\n\n')
            let masVotadas = movies.filter(function (elementos) {
                return elementos.vote_average >= 7
        ...
        case '/preguntas-frecuentes':
            ...
            res.write('\n\n')
            res.write('Preguntas respondidas: ' + faqs.length)
